"""Точка входа бота Уровни (пробой + ретест).

Запуск:  python bot_yrovni/main.py
Остановка: python launcher.py bot_yrovni
"""
...
from strategy import YrovniStrategy
