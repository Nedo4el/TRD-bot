...
Запуск:  python bot_screener_krugloe/main.py
Остановка: Ctrl+C
"""
...
from bot_screener_krugloe.printer import print_results
from bot_screener_krugloe.scanner import RoundSignal, scan_symbol
...
async def main() -> None:
    ...
    setup_logging("logs/screener_krugloe.log", "INFO")
