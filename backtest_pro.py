...
ALL_SYMBOLS = [
    "AKEUSDT", "BTRUSDT", "BRUSDT", "LSKUSDT", "NILUSDT",
    "ONDOUSDT", "XLMUSDT", "HBARUSDT", "CRVUSDT", "ETHFIUSDT",
    "PONSUSDT", "AEROUSDT", "STGUSDT", "ZROUSDT", "ASTERUSDT",
    "XPLUSDT", "FARTCOINUSDT", "RAYDIUMUSDT", "PIEVERSEUSDT", "CASHCATUSDT",
]
